...
=== Latest development version: #{site.pom.latest.version} and #{site.pom.latest_65x.version}
...
* image:download.png[] Download jBPM *#{site.pom.latest_65x.version}* binaries
** #{site.pom.latest_65x.jbpmBinZip}[Download jBPM #{site.pom.latest_65x.version}-bin.zip]
** #{site.pom.latest_65x.jbpmExamplesZip}[Download jBPM #{site.pom.latest_65x.version}-examples.zip]
** #{site.pom.latest_65x.jbpmInstallerZip}[Download jBPM #{site.pom.latest_65x.version}-installer.zip]
** #{site.pom.latest_65x.updatesite}[updatesite #{site.pom.latest_65x.version}]
** #{site.pom.latest_65x.releaseNotesVersion}[Release notes]
** License: link:../code/license.html[ASL 2.0]
