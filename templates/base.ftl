...
<head>
    ...
    <meta content="jBPM" property="og:site_name">
    <meta content="${(content.type == "post")?then("article", "website")}" property="og:type">
    <meta content="${config.canonicalBaseUrl + "/" + ((content.social_media_share_image??)?then(_uri?replace("/[^/]*$", "/", "r") + content.social_media_share_image, "headerFooter/jBPMLogo210px.png"))}" property="og:image">
    <meta content="summary" name="twitter:card">
    <meta content="@jbossjbpm" name="twitter:site">
    ...
    <link rel="stylesheet" href="${content.rootpath}website/jbpmWebsite.css">
...
<body>
    ...
    <script src="${content.rootpath}website/jbpmWebsite.js"></script>
    <script>
