    ...
    <div>
        ...
        <div class="card-body">
            <ol>
                ...
                <li>
                    On Linux/Mac, run: <br />
                    <code>jbpm-server/bin/standalone.sh</code>
                    <br />
                    On Windows, run: <br />
                    <code>jbpm-server\bin\standalone.bat</code>
                </li>
                <li>
                    Open browser and go to:<br />
                    <code>http://localhost:8080/business-central</code>
                </li>
                <li>
                    Login/password:<br />
                    <code>wbadmin/wbadmin</code>
                </li>
            </ol>
        ...
        <div class="card-body">
            <div style="text-align: center">
                <a class="btn btn-lg btn-primary"
                   href="${content.rootpath}learn/gettingStartedUsingSingleZipDistribution.html">
                    <img alt="Documentation" src="${content.rootpath}learn/documentation.png">
                    Get started now!
                </a>
                <p>Once you're done with getting started have a look at the documentation that covers much more.</p>
                <a class="btn btn-lg btn-primary" href="${pom.latestFinal.UserGuide}">
                    <img alt="Documentation" src="${content.rootpath}learn/documentation.png">
                    Read documentation
                </a>
            </div>
